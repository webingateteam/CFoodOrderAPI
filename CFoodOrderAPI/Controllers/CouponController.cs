...
namespace CFoodOrder.Controllers
{
    ...
    {
        [HttpGet]
        [Route("api/Coupon/GetOfferCounpons")]
        public DataTable GetOfferCounpons(dummy rc)
        {
            ...
            cmd.CommandText = "GetOfferCounpons";
        ...
        [HttpPost]
        [Route("api/Coupon/InsUpdOfferCoupons")]
        public DataTable InsUpdOfferCoupons(dummy rc)
        {
            DataTable dt = new DataTable();
            ...
            cmd.CommandText = "InsUpdOfferCoupons";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        [HttpGet]
        [Route("api/Coupon/ApplyOfferCoupons")]
        public DataTable ApplyOfferCoupons(dummy rc)
        {
            DataTable dt = new DataTable();
            ...
            cmd.CommandText = "ApplyOfferCoupons";
            cmd.CommandType = CommandType.StoredProcedure;
