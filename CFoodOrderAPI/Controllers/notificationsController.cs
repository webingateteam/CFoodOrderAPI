...
namespace CFoodOrder.Controllers
{
    ...
    {
        [HttpGet]
        [Route("api/notifications/RestNotificationTemplate")]

        public DataTable RestNotificationTemplate(dummy rc)
        {
            ...
            cmd.CommandText = "RestNotificationTemplate";
        ...
        [HttpGet]
        [Route("api/notifications/CustNotificationTemplate")]

        public DataTable CustNotificationTemplate(dummy rc)
        {
            DataTable dt = new DataTable();
            ...
            cmd.CommandText = "CustNotificationTemplate";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        [HttpGet]
        [Route("api/notifications/DSNotificationTemplate")]

        public DataTable DSNotificationTemplate(dummy rc)
        {
            DataTable dt = new DataTable();
            ...
            cmd.CommandText = "DSNotificationTemplate";
            cmd.CommandType = CommandType.StoredProcedure;
