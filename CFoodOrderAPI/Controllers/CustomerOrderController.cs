...
namespace CFoodOrder.Controllers
{
    ...
    {
        [HttpPost]
        [Route("api/CustomerOrder/GetCustomerOrderhistory")]
        public DataTable GetCustomerOrderhistory(dummy rc)
        {
        ...
        [HttpPost]
        [Route("api/CustomerOrder/Cancelorder")]
        public DataTable Cancelorder(dummy rc)
        {
            DataTable dt = new DataTable();
