...
namespace CFoodOrder.Controllers
{
    ...
    {
        [HttpGet]
        [Route("api/Cart/GetCartDetails")]
        public DataTable GetCartDetails(dummy rc)
        {
            ...
            cmd.CommandText = "GetCartDetails";
        ...
        [HttpPost]
        [Route("api/Cart/InsUpdCartDetails")]
        public DataTable InsUpdCartDetails(dummy rc)
        {
            DataTable dt = new DataTable();
            ...
            cmd.CommandText = "InsUpdCartDetails";
            cmd.CommandType = CommandType.StoredProcedure;
