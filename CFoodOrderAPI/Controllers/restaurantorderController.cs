...
namespace CFoodOrder.Controllers
{
    ...
    {
        [HttpPost]
        [Route("api/restaurantorder/ResAcceptRejectOrder")]

        public DataTable ResAcceptRejectOrder(dummy rc)
        {
            ...
            cmd.CommandText = "ResAcceptRejectOrder";
        ...
        [HttpPost]
        [Route("api/restaurantorder/InsUpdROrderDetails")]

        public DataTable InsUpdROrderDetails(dummy rc)
        {
            DataTable dt = new DataTable();
            ...
            cmd.CommandText = "InsUpdROrderDetails";
            cmd.CommandType = CommandType.StoredProcedure;
