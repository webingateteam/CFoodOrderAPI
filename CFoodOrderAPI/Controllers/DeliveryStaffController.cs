...
{
    public class DeliveryStaffController : ApiController
    {
        [HttpGet]
        [Route("api/DeliveryStaff/GetDeliveryStaff")]
        public DataTable GetDeliveryStaff()
        {
        ...
        [HttpPost]
        [Route("api/DeliveryStaff/InsUpdDeliveryStaff")]
        public DataTable InsUpdDeliveryStaff(DeliveryStaff rc)
        {
            DataTable dt = new DataTable();
            ...
            username.Value = rc.Username;
            cmd.Parameters.Add(username);

            SqlParameter email = new SqlParameter("@Email", SqlDbType.VarChar,50);
            email.Value = rc.Email;
            cmd.Parameters.Add(email);

            SqlParameter Mobilenumber = new SqlParameter("@Mobilenumber", SqlDbType.VarChar,20);
            Mobilenumber.Value = rc.Mobilenumber;
            cmd.Parameters.Add(Mobilenumber);

            SqlParameter pwd = new SqlParameter("@Password", SqlDbType.Int,20);
            pwd.Value = rc.Password;
            cmd.Parameters.Add(pwd);

            SqlParameter mobileotp = new SqlParameter("@Mobileotp", SqlDbType.Int,20);
            mobileotp.Value = rc.Mobileotp;
            cmd.Parameters.Add(mobileotp);

            SqlParameter Emailotp = new SqlParameter("@Emailotp", SqlDbType.VarChar,20);
            Emailotp.Value = rc.Emailotp;
            cmd.Parameters.Add(Emailotp);

            SqlParameter StatusId = new SqlParameter("@StatusId", SqlDbType.Int);
            StatusId.Value = rc.StatusId;
            cmd.Parameters.Add(StatusId);

            SqlParameter Mobileotpsenton = new SqlParameter("@Mobileotpsenton", SqlDbType.DateTime);
            Mobileotpsenton.Value = rc.Mobileotpsenton;
            cmd.Parameters.Add(Mobileotpsenton);

            SqlParameter emailotpsenton = new SqlParameter("@emailotpsenton", SqlDbType.DateTime);
            emailotpsenton.Value = rc.emailotpsenton;
            cmd.Parameters.Add(emailotpsenton);

            SqlParameter noofattempts = new SqlParameter("@noofattempts", SqlDbType.Int);
            noofattempts.Value = rc.noofattempts;
            cmd.Parameters.Add(noofattempts);
   
            SqlParameter Firstname = new SqlParameter("@Firstname", SqlDbType.VarChar,50);
            Firstname.Value = rc.Firstname;
            cmd.Parameters.Add(Firstname);

            SqlParameter lastname = new SqlParameter("@lastname", SqlDbType.VarChar,50);
            lastname.Value = rc.lastname;
            cmd.Parameters.Add(lastname);

            SqlParameter AuthTypeId = new SqlParameter("@AuthTypeId", SqlDbType.Int);
            AuthTypeId.Value = rc.AuthTypeId;
            cmd.Parameters.Add(AuthTypeId);

            SqlParameter AltPhonenumber = new SqlParameter("@AltPhonenumber", SqlDbType.VarChar,20);
            AltPhonenumber.Value = rc.AltPhonenumber;
            cmd.Parameters.Add(AltPhonenumber);

            SqlParameter Altemail = new SqlParameter("@Altemail", SqlDbType.VarChar,50);
        ...
        public DataTable ValidateMobileOTP(dummy rc)
        {
            ...
            cmd.CommandText = "ValidateMobileOTP";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable ValidateEmailOTP(dummy rc)
        {
            ...
            cmd.CommandText = "ValidateEmailOTP";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable GoOnlineOffline(dummy rc)
        {
            ...
            cmd.CommandText = "GoOnlineOffline";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable DeliveryStaffDashboard(dummy rc)
        {
            ...
            cmd.CommandText = "DeliveryStaffDashboard";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable ApproveRejectDeliveryStaff(dummy rc)
        {
            ...
            cmd.CommandText = "ApproveRejectDeliveryStaff";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable TrackOrderDelivery(dummy rc)
        {
            ...
            cmd.CommandText = "TrackOrderDelivery";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable InsUpdDeliveryStaffDetails(dummy rc)
        {
            ...
            cmd.CommandText = "InsUpdDeliveryStaffDetails";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable InsUpdDeliveryStaffDocs(dummy rc)
        {
            ...
            cmd.CommandText = "InsUpdDeliveryStaffDocs";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable GetPendingOrders(dummy rc)
        {
            ...
            cmd.CommandText = "GetPendingOrders";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable GetDSOrderHistory(dummy rc)
        {
            ...
            cmd.CommandText = "GetDSOrderHistory";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        [HttpGet]
        [Route("api/DeliveryStaff/GetDSEarningsHistory")]
        public DataTable GetDSEarningsHistory(dummy rc)
        {
            DataTable dt = new DataTable();
            ...
            cmd.CommandText = "GetDSEarningsHistory";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        [HttpPost]
        [Route("api/DeliveryStaff/ResetPassword")]
        ...
        [HttpPost]
        [Route("api/DeliveryStaff/validatepwdOTP")]
        public DataTable validatepwdOTP(dummy rc)
        {
            DataTable dt = new DataTable();
            ...
            cmd.CommandText = "validatepwdOTP";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        [HttpGet]
        [Route("api/DeliveryStaff/GetdeliveryStaffDetails")]
        public DataTable GetdeliveryStaffDetails(dummy rc)
        {
            DataTable dt = new DataTable();
            ...
            cmd.CommandText = "GetdeliveryStaffDetails";
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        [HttpPost]
        [Route("api/DeliveryStaff/InsUpdCustomerRatings")]
        public DataTable InsUpdCustomerRatings(dummy rc)
        {
            DataTable dt = new DataTable();
            ...
            cmd.CommandText = "InsUpdCustomerRatings";
            cmd.CommandType = CommandType.StoredProcedure;
